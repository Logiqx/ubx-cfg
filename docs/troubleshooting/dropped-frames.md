...
Dropped frames may be be resolved by configuration changes, generally relating to the clock rate(s), and maybe the baud rate. If the clock rates of the M10 and ESP32 have already been increased sufficiently, then too many satellites are being tracked and need to be limited.
